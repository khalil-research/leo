...
from utils import eval_learning_metrics
from utils import eval_rank_metrics
...
def train_lr(args):
    ...
    x_train_flat, y_train_flat = flatten_data(x_train, y_train)
    ...
    if 'test' in dataset:
        ...
        x_test_flat, y_test_flat = flatten_data(x_test, y_test)
    ...
    metrics['train'] = eval_learning_metrics(y_train_flat, y_train_pred)
    ...
    if y_val_flat is not None:
        ...
        metrics['val'] = eval_learning_metrics(y_val_flat, y_val_pred)
    ...
    if x_test_flat is not None:
        ...
        metrics['test'] = eval_learning_metrics(y_test_flat, y_test_pred)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss_weighted', type=int, default=0)
