...
struct BDDMultiObj
{
    ...
    static unsigned long int filter_dominance(BDD *bdd, const int layer, const int problem_type, const int dominance_strategy, MultiObjectiveStats *stats);

    // Filter layer based on dominance / knapsack
    static unsigned long int filter_dominance_knapsack(BDD *bdd, const int layer, MultiObjectiveStats *stats);

    // Filter layer based on dominance / set packing
    static unsigned long int filter_dominance_setpacking(BDD *bdd, const int layer, MultiObjectiveStats *stats);

    // Filter layer based on dominance / set covering
    static unsigned long int filter_dominance_setcovering(BDD *bdd, const int layer, MultiObjectiveStats *stats);
