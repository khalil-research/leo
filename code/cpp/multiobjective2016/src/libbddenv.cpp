...
PYBIND11_MODULE(libbddenv, m)
{
    py::class_<BDDEnv>(m, "BDDEnv")
        ...
        .def("compute_pareto_frontier_with_pruning", &BDDEnv::compute_pareto_frontier_with_pruning)
        .def("compute_pareto_frontier_anytime", &BDDEnv::compute_pareto_frontier_anytime)
