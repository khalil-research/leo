...
int main(int argc, char *argv[])
{
	...
	unsigned long int initial_width, initial_node_count, initial_arcs_count;
	unsigned long int reduced_width, reduced_node_count, reduced_arcs_count;
